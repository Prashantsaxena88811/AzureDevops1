    ...
    fetchSDSDocs: function (component, helper) {
        ...
        action.setCallback(this, function (response) {
            if (response.getState() == "SUCCESS" && response.getReturnValue() != null) {
                ...
                var sdsDoc = sdsDocs.sort(helper.dynamicSort(sortBy[0], "date", sortBy[1]));
                component.set("v.documentsMasterList", sdsDoc);
                var paginatedData = helper.paginateData(sdsDoc, component.get("v.currentProductPage"), component.get("v.pageSize"), helper);
    ...
    fetchProduct: function (component, event, helper) {
        ...
        action.setCallback(this, function (response) {
            if (response.getState() == "SUCCESS" && response.getReturnValue() != null) {
                ...
                var productss = products.sort(helper.dynamicSort(sortBy[0], "date", sortBy[1]));
                component.set("v.productsMasterList", productss);
                var paginatedData = helper.paginateData(productss, component.get("v.currentProductPage"), component.get("v.pageSize"), helper);
    ...
    fetchOrders: function (component, helper) {
        ...
        action.setCallback(this, function (response) {
            if (response.getState() == "SUCCESS" && response.getReturnValue() != null) {
                ...
                var orderss = orders.sort(helper.dynamicSort(sortBy[0], "date", sortBy[1]));
                component.set("v.ordersMasterList", orderss);
                var paginatedData = helper.paginateData(orderss, component.get("v.currentOrdersPage"), component.get("v.pageSize"), helper);
