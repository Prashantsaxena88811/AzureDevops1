({
	...
	doneRendering: function(component, event, helper) {
        ...
        phfromDate.set('v.placeholder','MM/DD/YYYY');
        phtoDate.set('v.placeholder','MM/DD/YYYY');
	},
    ...
    performSearch: function (component, event, helper) {
        ...
        // hide filter on tablet & mobile 
        var filterSection = component.find('showFilterModal');
        $A.util.removeClass(filterSection, 'show-filter');
    ...
    // display filter on tablet & mobile 
    showFilter: function (component, event, helper) {
        var filterSection = component.find('showFilterModal');
        $A.util.addClass(filterSection, 'show-filter');
